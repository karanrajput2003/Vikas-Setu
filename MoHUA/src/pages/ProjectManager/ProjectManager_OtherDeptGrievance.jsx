              ...
              <tbody className="text-gray-700">
                <tr className="border-b transition-colors hover:bg-gray-100">
                  <td className="py-4 px-4 font-medium text-blue-600">
                    <Link to={`/projectmanager/other_grievance_details?id=${123}`}>
                      123
                    </Link>
                  </td>
                  ...
                  <td className="py-4 px-4 text-center">
                    <Link
                      to={`/projectmanager/other_grievance_details?id=${123}`}
                ...
                <tr className="border-b transition-colors hover:bg-gray-100">
                  <td className="py-4 px-4 font-medium text-blue-600">
                    <Link to={`/projectmanager/other_grievance_details?id=${124}`}>
                      132
                    </Link>
                  </td>
                  <td className="py-4 px-4 hidden sm:table-cell">
                  ...
                  <td className="py-4 px-4 text-center">
                    <Link
                      to={`/projectmanager/other_grievance_details?id=${124}`}
                      className="text-indigo-600 hover:text-indigo-800"
                    >
                      View
                    </Link>
...
export default ProjectManager_OtherDeptGrievance